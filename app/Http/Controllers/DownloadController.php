...
class DownloadController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($request->type == 1) {
            ...
            $surveyses = Surveys::find($survey);
            $mitras = Mitras::orderBy($surveyses);
            foreach ($mitras as $mitra) {
                $sheet->setCellValue('A' . $i, $i);
                $sheet->setCellValue('B' . $i, $mitra['code']);
                $sheet->setCellValue('C' . $i, $mitra['email']);
            ...
            $sheet->insertNewRowBefore(1, 3)
                ...
                ->getRowDimension('2')
                ->setRowHeight('20');
            $sheet->setCellValue('A2', 'Data Mitra Survey Yang Sedang Berjalan');
            ...
            //HTTP Header Information
            header('Content-Type: application\vnd.openxmlformats-officedocument.spreadsheetml.sheet');
            header('Content-Disposition: attachment;filename="Mitra Survey Yang Sedang Berjalan.xlsx"');
            header('Cache-Control: max-age=0');
            ...
            $sheet->insertNewRowBefore(1, 3)
                ...
                ->getRowDimension('2')
                ->setRowHeight('20');
            $sheet->setCellValue('A2', 'Data Mitra Survey '. $survey->name);
            ...
            //HTTP Header Information
            header('Content-Type: application\vnd.openxmlformats-officedocument.spreadsheetml.sheet');
            header('Content-Disposition: attachment;filename="Mitra Survey '.$survey->name.'.xlsx"');
            header('Cache-Control: max-age=0');
