...
Route::get('/assessment-data/{id}', [App\Http\Controllers\AssessmentsController::class, 'data']);
...
Route::post('surveys/assessment', [App\Http\Controllers\AssessmentsController::class, 'create']);
