    ...
    <div class="col-lg-8">
        <form method="POST" action="/mitras" enctype="multipart/form-data">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" email="validationCustom03" placeholder="nama@gmail.com">
                @error('email')
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"  email="validationCustom03" >
                @error('code')
                <div class="invalid-feedback">
                  {{$message}}
                </div>
