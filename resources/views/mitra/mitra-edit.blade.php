                ...
                <div class="col-md-6">
                  <div class="col-md-14 mb-3">
                    ...
                    <select name="education" class="form-control" data-toggle="select">
                      ...
                      <option value="{{ $education->id }}" {{ old('education', $mitra->education) == $education->id ? 'selected' : '' }}>{{ $education->name }}</option>
                      @endforeach
                    </select>
                    @error('education')
                    <div class="text-valid">
                  ...
                  <div class="col-md-14">
                    ...
                    <select id="subdistrict" name="subdistrict" class="form-control" data-toggle="select" name="subdistrict" required>
                      ...
                      <option value="{{ $subdistrict->id }}" {{ old('subdistrict', $mitra->subdistrictdetail->id) == $subdistrict->id ? 'selected' : '' }}>{{ $subdistrict->name }}</option>
                      @endforeach
                    </select>
                  </div>
                  @error('subdistrict')
