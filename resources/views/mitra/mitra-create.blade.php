                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="phone"
                                                ...
                                                id="validationCustom03" value="{{ @old('phone') }}">
                                            @error('phone')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3 ">
                                            ...
                                            <input type="text" name="code"
                                                ...
                                                id="validationCustom03" readonly value="{{ @old('code', $code) }}">
                                            @error('code')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                id="validationCustom03" value="{{ @old('name') }}">
                                            @error('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="nickname"
                                                ...
                                                id="validationCustom03" value="{{ @old('nickname') }}">
                                            @error('nickname')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input name="birthdate"
                                                    ...
                                                    placeholder="Select date" type="date" value="{{ @old('birthdate') }}">
                                                @error('birthdate')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                                <input name="sex" class="custom-control-input" id="sex_radio1" value="L"
                                                    type="radio" {{ old('sex') == 'L' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="sex_radio1">Laki-laki</label>
                                            </div>

                                            <div class="custom-control custom-radio mb-3">
                                                <input name="sex" class="custom-control-input" id="sex_radio2" value="P"
                                                    type="radio" {{ old('sex') == 'P' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="profession"
                                                ...
                                                id="validationCustom03" value="{{ @old('profession') }}">
                                            @error('profession')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="address"
                                                ...
                                                id="validationCustom03" value="{{ @old('address') }}">
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
