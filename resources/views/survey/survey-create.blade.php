            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-2">Tambah Survey</h3>
                        <p class="mb-0"><small>*Wajib Diisi</small></p>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form action="/surveys" method="POST" autocomplete="off">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input name="start_date" class="form-control @error('start_date') is-invalid @enderror" placeholder="Select date" type="date" value="{{@old('start_date')}}">
                                    @error('start_date')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input name="end_date" class="form-control @error('end_date') is-invalid @enderror" placeholder="Select date" type="date" value="{{@old('end_date')}}">
                                    @error('end_date')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
